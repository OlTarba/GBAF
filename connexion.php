    ...
    if(!empty($_POST['pseudo']) && !empty($_POST['password'])){
        ...
        while($username = $reqUsername->fetch()){
            if($password === $username['password']){
                ...
                header('Location: /GBAF/connexion.php?error=1&message=Mot de passe incorrect');
                exit;
            }
        }

        header('Location: /GBAF/connexion.php?error=1&message=Pseudonyme incorrect');
    }   
...
<html lang="fr">
    ...
    <body>
        ...
        <div class="card-form form">
            ...
            <br>
            <p>Pas encore inscrit ? <a href="/GBAF/inscription.php" class="link-button">S'inscrire</a></p>
            <p><a href="/GBAF/system/forgot.php" class="link-button">Mot de passe oublié ?</a></p>
            <br>
